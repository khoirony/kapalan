...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Update My Company</h1>
    <br>
    <div class="row ml-3">
        <div class="col-md-5 pt-4">
            <form class="user" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="kota" name="kota" placeholder="City" value="<?= $perusahaan['kota']; ?>">
