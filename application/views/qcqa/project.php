            ...
            ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if ($t['selesai'] == 0) {
                            ?>
                                <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/progress/' . $t['id_pekerjaan']); ?>">Progress</a> <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/upload/' . $t['id_pekerjaan']); ?>">Upload</a> <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/revisi/' . $t['id_pekerjaan']); ?>">Revision</a>
                            <?php
                            } else {
                            ?>
