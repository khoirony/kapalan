...
<div class="container-fluid">
    ...
    <div style="float: right;" class="mr-3">
        ...
        if ($repair['selesai'] == 0) {
        ?>
            <a class="btn btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/selesairepair/' . $repair['id_repair']); ?>">Finish</a>
        <?php
        } else if ($repair['selesai'] == 1) {
        ?>
            <a class="btn btn-danger rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/batalkanrepair/' . $repair['id_repair']); ?>">Cancel</a>
        <?php
        }
        ?>
    ...
    <table class="table">
        <thead class="thead-dark">
            <tr>
                ...
                <th scope="col" class="text-center" width="27%">Aksi</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if ($t['selesai'] == 0) {
                            ?>
                                <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/progress/' . $t['id_pekerjaan']); ?>">Progress</a> <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/upload/' . $t['id_pekerjaan']); ?>">Result</a> <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/revisi/' . $t['id_pekerjaan']); ?>">Revision</a>
                            <?php
                            } else {
                            ?>
                                <a class="btn btn-warning rounded-pill pl-3 pr-3" href="<?= base_url('Qcqa/selesai/' . $t['id_pekerjaan']); ?>">Finish</a>
                            <?php
                            }
                            ?>
                        </td>
