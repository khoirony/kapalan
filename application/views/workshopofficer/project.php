            ...
            ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if ($t['selesai'] == 0) {
                            ?>
                                <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('WorkshopOfficer/progress/' . $t['id_pekerjaan']); ?>">Progress</a> <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('WorkshopOfficer/upload/' . $t['id_pekerjaan']); ?>">Result</a> <a class="btn btn-sm btn-primary rounded-pill pl-3 pr-3" href="<?= base_url('WorkshopOfficer/revisi/' . $t['id_pekerjaan']); ?>">Revision</a>
                            <?php
                            } else {
                            ?>
